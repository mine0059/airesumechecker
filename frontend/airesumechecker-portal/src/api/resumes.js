...
export const resumesApi = {
  ...
  //   const analysis = mockAnalyses[versionId] || mockAnalyses[Object.keys(mockAnalyses)[0]];
  //   return { analysis };
  // },
  ...
  //   await mockDelay();
  //   const resume = findMockResume(id);
  //   const analyses = (resume?.versions || []).map((v) => mockAnalyses[v._id]).filter(Boolean);
  //   return { analyses };
  // },
  ...
  //       {
  //         type: 'add',
  //         text: 'Shipped 4 React analytics dashboards adopted by 12k+ daily users — cut load time 38%.',
  //       },
  //       {
  //         type: 'context',
  //         text: 'Led migration from Webpack to Vite — build times down from 92s to 11s.',
  //       },
